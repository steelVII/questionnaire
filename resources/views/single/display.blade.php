...
<section class="section">
    ...
    <div class="container">
        ...
        <h1 class="title">Wep Application</h1>
        <div class="content box">
    
            <div class="columns">
                <div class="column">
                    <h5 class="has-text-weight-semibold"><i class="fas fa-list"></i> Description</h5>
                    <p>{{ $single->web_app }}</p>
                </div>
            </div>
        ...
        <h1 class="title">Person in Charge</h1>
        <div class="content box">
    
            <div class="columns">
                <div class="column">
                    <h5 class="has-text-weight-semibold"><i class="fas fa-user"></i> Name</h5>
                    <p>{{ $single->in_charge }}</p>
                </div>
            </div>
